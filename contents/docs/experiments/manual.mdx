...
- The impact of offering a free trial period versus a money-back guarantee to determine which approach results in more paying customers.
...
The default is users, but if you've created [groups](/docs/product-analytics/group-analytics) in PostHog, you can use this field to run [group-targeted experiments](/blog/running-group-targeted-ab-tests). This will test how a change affects your product at a group-level. 
...
Setting your goal metric enable PostHog to calculate the impact of your experiment and if your results are [statistically significant](/docs/experiments/significance). You can select between a "trend" or "conversion funnel" goal.

You set the minimum acceptable improvement below. This combines historical data from your goal metric with your desired improvement rate to show you how long you'll need to run your experiment for in order to see statistical significant results.
...
-   [8 annoying A/B testing mistakes every engineer should know][/tutorials/experiments]
